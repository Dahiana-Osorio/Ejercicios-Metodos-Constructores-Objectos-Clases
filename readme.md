...
## Participantes
Leidy Dahiana osorio 
Catalina Jaramillo palacios
...
var dahiana= new persona("Catalina", 22, 5651565252);
console.log(dahiana.mostrar())
console.log(dahiana.mayoredad())
```
![Alt text](./img/ejer1.jpg?raw=true "Title")
...
```
![Alt text](./img/ejer2.jpg?raw=true "Title")
